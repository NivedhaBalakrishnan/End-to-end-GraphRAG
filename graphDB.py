...
class GraphDBNeo4J():
    def __init__(self):
        ...
        self.VECTOR_SOURCE_PROPERTY = 'Entity'  # or any other property you want to use as the source
    ...
    def create_vector_index(self):
        try:
            ...
            """)
            self.log.info("Created vector index")
    ...
    def calculate_entity_embeddings(self, merged_chunk):
        ...
        update_entity_embedding_query = f"""
            MATCH (e:Entity {{entityId: $entityId}})
            SET e.{self.VECTOR_EMBEDDING_PROPERTY} = $embedding
        """
        params = {
            "entityId": merged_chunk['entityId'],
            "embedding": embedding
...
#------------------------------------------------------------------------------------------------------------#
    ...
    #                     ENTITY_PROPERTIES: {
    #                         embedding: {
    #                             propertyName: $embedding_property,
    #                             defaultValue: []
    #                         }
    #                     },
    ...
    #             )
    #         """, params={
    #             "graph_name": self.VECTOR_INDEX_NAME,
    #             "node_label": self.VECTOR_NODE_LABEL,
    #             "embedding_property": self.VECTOR_EMBEDDING_PROPERTY
    #         })

    #         self.kg.query("""
    #             CALL gds.graph.nodeProperties.update(
    #                 $graph_name,
    #                 'embedding',
    #                 {
    #                     propertyName: $embedding_property,
    ...
    #         self.kg.query("""
    #             CALL gds.graph.nodeProperties.autoIndex(
    #                 $graph_name,
    #                 'embedding',
    #                 {
    #                     propertyName: $embedding_property,
    ...
    #         self.log.info("Created vector index for entity embeddings")
    #     except Exception as e:
    #         self.log.error(f"Error creating vector index: {e}")
    #         raise e
